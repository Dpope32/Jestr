...
export const Conversations = () => {
  ...
  const loadMessages = useCallback(async () => {
    ...
    const storedConversation = useInboxStore
      .getState()
      .conversations.find(conv => conv.ConversationID === conversation.id);
      ...
      useInboxStore.setState(state => {
        ...
        if (conversationExists) {
          ...
          const newConversation: Conversation = {
            ...
            UnreadCount: 0,
            LastReadMessageID: '',
            partnerUser: partnerUser as any,
          };
          ...
          <TouchableOpacity
            ...
            <Animated.View
              style={{
                transform: [
                  {
                    rotate: sendingAnimation.interpolate({
                      inputRange: [0, 1, 2],
