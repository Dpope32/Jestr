...
import {View, TouchableOpacity, Text, Platform, Image, Dimensions, StyleSheet} from 'react-native';
import { SPACING, FONT_SIZES} from '../../theme/theme';
import { handleGoogleSignIn, handleAppleSignIn } from '../../services/authService';
...
const SocialLoginBtns: React.FC = () => {
  const navigation = useNavigation<AuthNavProp>();
      return (
        ...
        {Platform.OS === 'ios' && (
          <TouchableOpacity style={styles.socialButton} onPress={() => handleAppleSignIn(navigation)}>
              <Image source={require('../../assets/icons/apple.png')} style={styles.icon}/>
              <Text style={styles.buttonText}>Continue with Apple</Text>
          </TouchableOpacity>
        )}

      <TouchableOpacity style={styles.socialButton} onPress={() => handleGoogleSignIn(navigation)}>
