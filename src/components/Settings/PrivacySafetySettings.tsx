...
import { faEnvelope, faAddressBook, faUserLock } from '@fortawesome/free-solid-svg-icons';
    ...
    <View style={styles.settingSection}>
      ...
      <View style={styles.settingItem}>
        ...
        <Switch
          ...
          onValueChange={(value) => updatePrivacySafety({ allowDMsFromEveryone: value })}
        />
      </View>
      <View style={styles.settingItem}>
        ...
        <Switch
          ...
          onValueChange={(value) => updatePrivacySafety({ allowDMsFromFollowersOnly: value })}
        />
      </View>
    </View>
  );
