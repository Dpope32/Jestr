...
const AccessibilitySettings: React.FC = () => {
  const { accessibility, privacySafety, updatePrivacySafety, updateAccessibility } = useSettingsStore();
  ...
  return (
    <View>
      ...
      <View style={styles.settingSection}>
        ...
        <TouchableOpacity style={styles.languageButton} onPress={() => {/* Open language selection modal */}}>
